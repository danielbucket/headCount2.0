...
describe.skip('DistrictRepository iteration 4', () =>  {
  const district = new DistrictRepository(kinderData);

  test('1: findAverage for ACADEMY 20', () => {
    expect(district.findAverage('ACADEMY 20')).toBe(.407)
  });

  test('2: compareDistrictAverages ACADEMY 20 against YUMA SCHOOL DISTRICT 1', () => {
  ...
  test('3: compareDistrictAverages is case insensitive', () => {
    const result =  { "ACADEMY 20": 0.407, "YUMA SCHOOL DISTRICT 1": 0.909, "compared": 0.448 }
    expect(district.compareDistrictAverages('ACADeMY 20', 'YUMA ScHOoL DiStRICT 1')).toEqual(result);
  });

  test('4:compareDistrictAverages ACADEMY 20 against Colorado', () => {
